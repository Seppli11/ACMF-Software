...
public class UndoManager {
	...
	public void add(Action a) {
		if(isDoing()) {
			System.out.println("Undomanager is doing something! add(Action) will be skipped!");
			return;
		}
		System.out.println("Added action: " + a);
	...
	public void undo() {
		if(undoActionStack.empty()) return;
		isDoing = true;
	...
	public void redo() {
		if(redoActionStack.empty()) return;
		isDoing = true;
